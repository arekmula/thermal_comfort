...
mlf.set_experiment("regs k_features & ps no outliers/with night_hours and weekends")
mlfs.autolog()
...
def main(args):
    ...
    for past_samples in past_samples_arr:
        ...
        for k in k_best_features:
            with mlf.start_run(run_name=f"k={k}, ps={past_samples}") as run:
